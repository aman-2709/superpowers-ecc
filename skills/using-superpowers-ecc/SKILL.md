...
**In Cursor / OpenCode / Codex CLI:** Check your platform's documentation for how skills are loaded. Cross-platform config files are in `.cursor/`, `.opencode/`, and `.codex/` respectively.
